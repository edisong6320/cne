...
<div class="container contenedor">
  <br>
  <h1 class="text-center">UBICACIONES DE LOS ASAMBLEISTAS NACIONALES</h1>
      <div class="col-md-12">
  			<div id="mapaAsambleistasNac" style="height:500px; width:100%;border:2px solid black;"></div>
  		</div>
  		<script type="text/javascript">
  			function initMap(){
  				var centro=new google.maps.LatLng(-1.2595931997473242, -78.54164276317397);
  				var mapaAsambleistasNac=new google.maps.Map(document.getElementById('mapaAsambleistasNac'),
  					{
  						center:centro,
  						zoom:7,
